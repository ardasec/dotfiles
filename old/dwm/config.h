...
static char *fonts[]          = { "JetBrains Mono:style=Regular:size=16", "Font Awesome 6 Free:pixelsize=10:antialias=true:autohint=true"  };
static char normbgcolor[]           = "#2d353b";
static char normbordercolor[]       = "#475258";
static char normfgcolor[]           = "#d3c6aa";
static char selfgcolor[]            = "#232a2e";
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_d,          spawn,                  {.v = (const char*[]){ "dmenu_run", "-nb", "#2d353b", "-nf", "#d3c6aa", "-sb", "#a7c080", "-sf", "#232a2e", "-fn", "JetBrains Mono-10",  NULL } } },
